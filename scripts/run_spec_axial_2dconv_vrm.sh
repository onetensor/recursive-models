...
SKIP_DATASET=0
NUM_GPUS=1
RUN_NAME="pretrain_axial_2dconv_sudoku_spec_vrm"

usage() {
  cat <<'EOF'
Usage: bash scripts/run_spec_axial_2dconv_vrm.sh [options]
...
Options:
  ...
  --run-name <name>            Run name (default: pretrain_axial_2dconv_sudoku_spec_vrm)
...
echo "Axial + 2dconv run submitted."
